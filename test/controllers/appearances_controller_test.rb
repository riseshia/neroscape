...
class AppearancesControllerTest < ActionController::TestCase
  ...
  test "should create appearance" do
    assert_difference('Appearance.count') do
      post :create, appearance: { creator_id: @appearance.creator_id, game_id: @appearance.game_id, role_id: @appearance.role_id }
    end
  ...
  test "should update appearance" do
    patch :update, id: @appearance, appearance: { creator_id: @appearance.creator_id, game_id: @appearance.game_id, role_id: @appearance.role_id }
    assert_redirected_to appearance_path(assigns(:appearance))
  end
